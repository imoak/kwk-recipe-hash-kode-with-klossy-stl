...
perfect_10_recipe = {almond_flour: "2 cups", gluten_freewhole_oats: "1 cup", kosher_salt: "1/2 teaspoon", baking_powder: "1/2 teaspoon", baking_soda: "1/4 teaspoon", xanthan_gum: "1/2 teaspoon", slivered_almonds: "1/4 cup", mini_dark_chocolate_chips: "3/4 cup", olive_oil: "1/2 cup", agave: "1/4 cup"}
...
def ingredients_and_amounts(perfect_10_recipe)
  perfect_10_recipe.each do |key, val|
    puts "#{key} #{val}"
  end
end
